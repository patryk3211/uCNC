...
#define CREATE_EVENT_LISTENER_WITHLOCK(name, handler, lock_flags) __attribute__((used)) name##_delegate_event_t name##_delegate_##handler = {&handler, CHECKFLAG(lock_flags, LISTENER_RUNNING_LOCK), NULL}
